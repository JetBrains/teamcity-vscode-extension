...
suite("GitCommandArgumentsParser", () => {
    ...
    const parser = new GitStatusRowsParser(settingsSpy);
    const workspaceRootPath = "workspaceRootPath";

    test("should verify parsing of one correct row from index | changes from index", function () {
    ...
    test("should verify parsing of one incorrect row from index | changes from index", function () {
        when(settingsMock.shouldCollectGitChangesFromIndex()).thenReturn(true);
    ...
    test("should verify parsing of two correct row from index | changes from index", function () {
        when(settingsMock.shouldCollectGitChangesFromIndex()).thenReturn(true);
        const statusRow = "A  path1/path2/path3/file1";
    ...
    test("should verify parsing of two rows: correct/incorrect from index | changes from index", function () {
        when(settingsMock.shouldCollectGitChangesFromIndex()).thenReturn(true);
        const statusRow = "A  path1/path2/path3/file1";
    ...
    test("should verify parsing of one correct row from working tree | changes from working tree", function () {
    ...
    test("should verify parsing of one incorrect row from working tree | changes from working tree", function () {
        when(settingsMock.shouldCollectGitChangesFromIndex()).thenReturn(false);
        const statusRow = " U path1/path2/path3/file1";
    ...
    test("should verify parsing of two correct row from working tree | changes from working tree", function () {
        when(settingsMock.shouldCollectGitChangesFromIndex()).thenReturn(false);
        const statusRow = " A path1/path2/path3/file1";
    ...
    test("should verify parsing of two rows: correct/incorrect from working tree | changes from working tree", function () {
        when(settingsMock.shouldCollectGitChangesFromIndex()).thenReturn(false);
        const statusRow = " A path1/path2/path3/file1";
        const statusRow2 = " U path1/path2/path3/file1";
    ...
    test("should verify parsing of two rows: correct row from index and working tree | changes from index", function () {
        when(settingsMock.shouldCollectGitChangesFromIndex()).thenReturn(true);
        const statusRow = "A  path1/path2/path3/file1";
    ...
    test("should verify parsing of two rows: correct row from index and working tree | changes from working tree", function () {
        when(settingsMock.shouldCollectGitChangesFromIndex()).thenReturn(false);
        const statusRow = "A  path1/path2/path3/file1";
        const statusRow2 = " A path3/path4/path5/file2";
