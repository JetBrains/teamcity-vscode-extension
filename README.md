# TeamCity Extension for Visual Studio Code [![JetBrains incubator project](assets/project-incubator-brightgreen.svg)](https://confluence.jetbrains.com/display/ALL/JetBrains+on+GitHub)
